...
void GradeBook::setInstructorName(string iname)/* write code to define a get member function for the instructor's name */
{
	instructorName = iname ;
}

string GradeBook::getInstructorName()/* write code to define a set member function for the instructor's name */
{
